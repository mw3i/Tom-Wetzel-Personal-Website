  ...
  return (
    <div>
      <div className="relative aspect-[5/4] w-full max-w-lg">
        {bottomLeft && (
          <div className="absolute bottom-0 left-0 aspect-[4/3] w-3/5 overflow-hidden rounded-sm shadow-lg shadow-ink/20">
            <Image src={bottomLeft} alt="" fill className="object-cover" />
          </div>
        )}
        {topRight && (
          <div className="absolute right-0 top-0 aspect-[4/3] w-3/5 overflow-hidden rounded-sm border-4 border-navy shadow-lg shadow-ink/20">
